...
import { X, Bot, Sparkles, Clock, CheckCircle, AlertCircle } from "lucide-react";
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-700">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Analyzing your email</p>
              </div>
            </div>
            <button
          ...
          <div className="max-h-80 overflow-y-auto">
            {!agentData ? (
              <div className="p-6 text-center">
                ...
                <p className="text-gray-400">AI is analyzing your email...</p>
              </div>
            ) : (
                    ...
                    >
                      <div className="flex items-start space-x-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className={`whitespace-pre-wrap ${isError ? "text-red-300" : "text-gray-300"}`}>
                            {step.replace("✅", "").replace("❌", "").trim()}
                          </p>
                        </div>
                      </div>
                    </div>
